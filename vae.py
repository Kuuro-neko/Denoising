...
def parse_args():
    ...
    p.add_argument('--data-root', type=str, default='image_database/patchesx64', help='root directory containing clean/ and noisy/')
    ...
    p.add_argument('--demo-image', type=str, default='demo64x64.jpg')
