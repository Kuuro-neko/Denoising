...
def denoise_image(image_path, model_path="checkpoint_epoch_14.pth", save_path=None, method="patches"):
    """
...
def denoise_folder(input_folder, output_folder, model_path="checkpoint_epoch_14.pth", method="patches"):
    """
